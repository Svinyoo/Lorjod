...
แอพ iOS แยกสำหรับ Renter, Landlord และ Admin อยู่ใน `Mobile app/iOS` อ่านวิธีตั้งค่า Xcode ติดตั้งบน iPhone และเข้าใช้งานที่ [Readme_appIOS.md](Readme_appIOS.md) รุ่นนี้เป็น SwiftUI/WKWebView ที่ใช้เซิร์ฟเวอร์เดิม ยังไม่มีไฟล์ติดตั้งที่เซ็นหรือเผยแพร่แล้ว

แอพ Android แยกสามบทบาทอยู่ใน `Mobile app/Android` อ่านการตั้งค่า สร้าง APK ติดตั้งและเข้าใช้งานที่ [Readme_appAndoird.md](Readme_appAndoird.md)
